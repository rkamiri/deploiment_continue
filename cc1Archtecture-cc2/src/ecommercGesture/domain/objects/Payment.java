...
public class Payment {
	...
	private Payment(Id id, Id user, double transactionPrice, LocalDate paymentDate) {
		this.id = id;
		this.userId = Objects.requireNonNull(user,"User id must be not null");
    ...
    public static Payment of(Id id, Id user, double transactionPrice,LocalDate paymentDate) {
	...
	public String toString() {
		return "Payment [id=" + id + ", user=" + userId + ", transactionPrice=" + transactionPrice + ", paymentDate="
				+ paymentDate + "]";
	}
